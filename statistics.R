...
hg + geom_histogram(binwidth =100000,
  ...
  labs(y = "Number of Houses", x = "Price") +
  theme_minimal() +
...
sp <- ggplot(data=product, aes(`Area..ft..`, Price))
sp + geom_point() + theme_light() +
  labs(x='Area in Square Feet', y='Price in USD', title='Relationship b/w Price and Area') +
